...
const SavvyEducationPage = () => {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Tech Savvy Syllabus - Master Your Digital Life | Rahvion</title>
        <meta name="description" content="Education is the foundation of confidence. We teach you to understand, not just use." />
      </Helmet>
          ...
          >
             ...
             <a href="mailto:helpdesk@rahvion.com?subject=Core%20Plan%20Signup%20-%20%2425%2Fmo">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-10 py-6 text-lg rounded-full">
                Enroll in Savvy Syllabus via Membership
              </Button>
            </a>
          </motion.div>
        </div>
...
export default SavvyEducationPage;